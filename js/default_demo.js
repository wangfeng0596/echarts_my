...
require([ 'jquery',"component/zSearchComponent","easyUI/jquery.datagrid","layer"],function($,zSearchComponent) {
      ...
      $(document).ready(function(){
            ...
            var tableConfig = {
                ...
                columns:[[
                    {field:'itemid',title:'Item ID(%)',width:"200",align:'center',sortable:true},
                    {field:'listprice',title:'List Price',width:"200",align:'center',sortable:true},
                    {field:'unitcost',title:'Unit Cost',width:"200",align:'center',sortable:true},
                    {field:'attr1',title:'Attribute',width:"200",align:'center',sortable:true},
                    {field:'date',title:'Date',sortable:true,width:"200",align:'center'},
                    {field:'id',title:'操作',width:"200",align:'center',sortable:true,
